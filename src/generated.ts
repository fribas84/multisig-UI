// Generated by @wagmi/cli@1.3.0 on 7/31/2023 at 11:56:42 AM
import {
  useContractRead,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link multiSigWalletABI}__ and `functionName` set to `"createWithdrawTx"`.
 *
 *
 */
export function useMultiSigWalletCreateWithdrawTx<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof multiSigWalletAddress,
>(
  config: TMode extends 'prepared'
  ...
  return useContractWrite<typeof multiSigWalletABI, 'createWithdrawTx', TMode>({
    abi: multiSigWalletABI,
    address: multiSigWalletAddress[31337],
    functionName: 'createWithdrawTx',
    ...config,
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link multiSigWalletABI}__ and `functionName` set to `"createWithdrawTx"`.
 *
 *
 */
export function usePrepareMultiSigWalletCreateWithdrawTx(
  config: Omit<
    UsePrepareContractWriteConfig<typeof multiSigWalletABI, 'createWithdrawTx'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof multiSigWalletAddress } = {} as any,
) {
  return usePrepareContractWrite({
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link multiSigWalletABI}__ and `eventName` set to `"CreateWithdrawTx"`.
 *
 *
 */
export function useMultiSigWalletCreateWithdrawTxEvent(
  config: Omit<
    UseContractEventConfig<typeof multiSigWalletABI, 'CreateWithdrawTx'>,
    'abi' | 'address' | 'eventName'
  > & { chainId?: keyof typeof multiSigWalletAddress } = {} as any,
) {
  return useContractEvent({
    ...
    ...config,
  } as UseContractEventConfig<typeof multiSigWalletABI, 'CreateWithdrawTx'>)
}
